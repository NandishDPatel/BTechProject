...
document
  .querySelectorAll(".men_content4 .product_quick1")
  .forEach((product) => {
    product.onclick = () => {
...
// shoe size selection -> background colour change
var sizes = document.querySelectorAll(".products-preview .preview .size li");
// console.log(sizes);
// sizes[0].style.background = "purple";

// function defaultColors(){
//   for(let i=0;i<sizes.length;i++){
//     var btn = sizes[i];
//     btn.classList.add("quickViewButton");
//   }
// }
//  defaultColors();
...
//     // console.log("Clicked!");
//     // btn1.classList.add("quickViewButton");
//     })
// }
for (let i = 0; i < sizes.length; i++) {
  btn1 = sizes[i];
